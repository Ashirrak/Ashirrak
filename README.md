...
🎓 I'm a Master's student in **Bioinformatics** with a passion for building impactful tools at the intersection of **health**, **data science**, and **technology**. I enjoy solving real-world problems using code, especially in healthcare and life sciences.
...
### 🧪 Tools & OS:
- `Linux (Debian)` · `Git/GitHub` · `Terminal scripting`
- `UI/UX tools` like Figma and web templates
